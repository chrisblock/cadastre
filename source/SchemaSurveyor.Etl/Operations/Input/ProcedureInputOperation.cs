...
{
	public class ProcedureInputOperation : SimpleInputCommandOperation
	{
		...
		public ProcedureInputOperation(string connectionString) : base(connectionString)
		{
		}

		public ProcedureInputOperation(string server, string database) : base(server, database)
		{
		}

		public ProcedureInputOperation(SqlConnectionStringBuilder connectionStringBuilder) : base(connectionStringBuilder)
		{
		}
