...
{
	public class FunctionInputOperation : SimpleInputCommandOperation
	{
		...
		private static string BuildSelectSql()
		{
			...
			stringBuilder.AppendLine("FROM [sys].[objects]");
			stringBuilder.AppendLine("WHERE [type] IN (N'FN', N'IF', N'TF', N'FS', N'FT')");

			return stringBuilder.ToString();
		}

		public FunctionInputOperation(string connectionString) : base(connectionString)
		{
		}

		public FunctionInputOperation(string server, string database) : base(server, database)
		{
		}

		public FunctionInputOperation(SqlConnectionStringBuilder connectionStringBuilder) : base(connectionStringBuilder)
		{
		}
